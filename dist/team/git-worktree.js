...
export function getWorkerWorktreePath(repoRoot, teamName, workerName) {
...
function getLegacyWorktreePath(repoRoot, teamName, workerName) {
...
function buildInfo(teamName, workerName, repoRoot, created, reused) {
    return {
